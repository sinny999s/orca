--[[
-- Sinny, a free and open-source Roblox script hub.
...
-- License: MIT
-- Version: "22d154a-dbg"
-- GitHub: https://github.com/sinny999s/orca
--]]
...
newInstance("Sinny", "Folder", "Sinny", nil)

newModule("App", "ModuleScript", "Sinny.App", "Sinny", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.App")) setfenv(fn, newEnv("Sinny.App")) return fn() end)

newInstance("components", "Folder", "Sinny.components", "Sinny")

newModule("Acrylic", "ModuleScript", "Sinny.components.Acrylic", "Sinny.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Acrylic\").default\
return exports\
", '@'.."Sinny.components.Acrylic")) setfenv(fn, newEnv("Sinny.components.Acrylic")) return fn() end)

newModule("Acrylic", "ModuleScript", "Sinny.components.Acrylic.Acrylic", "Sinny.components.Acrylic", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.components.Acrylic.Acrylic")) setfenv(fn, newEnv("Sinny.components.Acrylic.Acrylic")) return fn() end)

newModule("Acrylic.story", "ModuleScript", "Sinny.components.Acrylic.Acrylic.story", "Sinny.components.Acrylic", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
...
", '@'.."Sinny.components.Acrylic.Acrylic.story")) setfenv(fn, newEnv("Sinny.components.Acrylic.Acrylic.story")) return fn() end)

newModule("acrylic-instance", "ModuleScript", "Sinny.components.Acrylic.acrylic-instance", "Sinny.components.Acrylic", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.components.Acrylic.acrylic-instance")) setfenv(fn, newEnv("Sinny.components.Acrylic.acrylic-instance")) return fn() end)

newModule("ActionButton", "ModuleScript", "Sinny.components.ActionButton", "Sinny.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.components.ActionButton")) setfenv(fn, newEnv("Sinny.components.ActionButton")) return fn() end)

newModule("Border", "ModuleScript", "Sinny.components.Border", "Sinny.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
...
", '@'.."Sinny.components.Border")) setfenv(fn, newEnv("Sinny.components.Border")) return fn() end)

newModule("BrightButton", "ModuleScript", "Sinny.components.BrightButton", "Sinny.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
...
", '@'.."Sinny.components.BrightButton")) setfenv(fn, newEnv("Sinny.components.BrightButton")) return fn() end)

newModule("BrightSlider", "ModuleScript", "Sinny.components.BrightSlider", "Sinny.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.components.BrightSlider")) setfenv(fn, newEnv("Sinny.components.BrightSlider")) return fn() end)

newModule("Canvas", "ModuleScript", "Sinny.components.Canvas", "Sinny.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
...
", '@'.."Sinny.components.Canvas")) setfenv(fn, newEnv("Sinny.components.Canvas")) return fn() end)

newModule("Card", "ModuleScript", "Sinny.components.Card", "Sinny.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Acrylic = TS.import(script, script.Parent, \"Acrylic\").default\
...
", '@'.."Sinny.components.Card")) setfenv(fn, newEnv("Sinny.components.Card")) return fn() end)

newModule("Fill", "ModuleScript", "Sinny.components.Fill", "Sinny.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local mapBinding = TS.import(script, script.Parent.Parent, \"utils\", \"binding-util\").mapBinding\
...
", '@'.."Sinny.components.Fill")) setfenv(fn, newEnv("Sinny.components.Fill")) return fn() end)

newModule("Glow", "ModuleScript", "Sinny.components.Glow", "Sinny.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.components.Glow")) setfenv(fn, newEnv("Sinny.components.Glow")) return fn() end)

newModule("ParallaxImage", "ModuleScript", "Sinny.components.ParallaxImage", "Sinny.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local mapBinding = TS.import(script, script.Parent.Parent, \"utils\", \"binding-util\").mapBinding\
local scale = TS.import(script, script.Parent.Parent, \"utils\", \"udim2\").scale\
...
", '@'.."Sinny.components.ParallaxImage")) setfenv(fn, newEnv("Sinny.components.ParallaxImage")) return fn() end)

newModule("constants", "ModuleScript", "Sinny.constants", "Sinny", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.constants")) setfenv(fn, newEnv("Sinny.constants")) return fn() end)

newInstance("context", "Folder", "Sinny.context", "Sinny")

newModule("scale-context", "ModuleScript", "Sinny.context.scale-context", "Sinny.context", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
...
", '@'.."Sinny.context.scale-context")) setfenv(fn, newEnv("Sinny.context.scale-context")) return fn() end)

newInstance("hooks", "Folder", "Sinny.hooks", "Sinny")

newInstance("common", "Folder", "Sinny.hooks.common", "Sinny.hooks")

newModule("flipper-hooks", "ModuleScript", "Sinny.hooks.common.flipper-hooks", "Sinny.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
...
return exports\
", '@'.."Sinny.hooks.common.flipper-hooks")) setfenv(fn, newEnv("Sinny.hooks.common.flipper-hooks")) return fn() end)

newModule("get-binding", "ModuleScript", "Sinny.hooks.common.flipper-hooks.get-binding", "Sinny.hooks.common.flipper-hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.hooks.common.flipper-hooks.get-binding")) setfenv(fn, newEnv("Sinny.hooks.common.flipper-hooks.get-binding")) return fn() end)

newModule("use-goal", "ModuleScript", "Sinny.hooks.common.flipper-hooks.use-goal", "Sinny.hooks.common.flipper-hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.hooks.common.flipper-hooks.use-goal")) setfenv(fn, newEnv("Sinny.hooks.common.flipper-hooks.use-goal")) return fn() end)

newModule("use-instant", "ModuleScript", "Sinny.hooks.common.flipper-hooks.use-instant", "Sinny.hooks.common.flipper-hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.hooks.common.flipper-hooks.use-instant")) setfenv(fn, newEnv("Sinny.hooks.common.flipper-hooks.use-instant")) return fn() end)

newModule("use-linear", "ModuleScript", "Sinny.hooks.common.flipper-hooks.use-linear", "Sinny.hooks.common.flipper-hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.hooks.common.flipper-hooks.use-linear")) setfenv(fn, newEnv("Sinny.hooks.common.flipper-hooks.use-linear")) return fn() end)

newModule("use-motor", "ModuleScript", "Sinny.hooks.common.flipper-hooks.use-motor", "Sinny.hooks.common.flipper-hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.hooks.common.flipper-hooks.use-motor")) setfenv(fn, newEnv("Sinny.hooks.common.flipper-hooks.use-motor")) return fn() end)

newModule("use-spring", "ModuleScript", "Sinny.hooks.common.flipper-hooks.use-spring", "Sinny.hooks.common.flipper-hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Spring = TS.import(script, TS.getModule(script, \"@rbxts\", \"flipper\").src).Spring\
local useGoal = TS.import(script, script.Parent, \"use-goal\").useGoal\
...
", '@'.."Sinny.hooks.common.flipper-hooks.use-spring")) setfenv(fn, newEnv("Sinny.hooks.common.flipper-hooks.use-spring")) return fn() end)

newModule("rodux-hooks", "ModuleScript", "Sinny.hooks.common.rodux-hooks", "Sinny.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.hooks.common.rodux-hooks")) setfenv(fn, newEnv("Sinny.hooks.common.rodux-hooks")) return fn() end)

newModule("use-delayed-update", "ModuleScript", "Sinny.hooks.common.use-delayed-update", "Sinny.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local useEffect = _roact_hooked.useEffect\
local useMutable = _roact_hooked.useMutable\
...
", '@'.."Sinny.hooks.common.use-delayed-update")) setfenv(fn, newEnv("Sinny.hooks.common.use-delayed-update")) return fn() end)

newModule("use-did-mount", "ModuleScript", "Sinny.hooks.common.use-did-mount", "Sinny.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local useEffect = _roact_hooked.useEffect\
local useMutable = _roact_hooked.useMutable\
...
", '@'.."Sinny.hooks.common.use-did-mount")) setfenv(fn, newEnv("Sinny.hooks.common.use-did-mount")) return fn() end)

newModule("use-forced-update", "ModuleScript", "Sinny.hooks.common.use-forced-update", "Sinny.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local useCallback = _roact_hooked.useCallback\
local useState = _roact_hooked.useState\
...
", '@'.."Sinny.hooks.common.use-forced-update")) setfenv(fn, newEnv("Sinny.hooks.common.use-forced-update")) return fn() end)

newModule("use-interval", "ModuleScript", "Sinny.hooks.common.use-interval", "Sinny.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.hooks.common.use-interval")) setfenv(fn, newEnv("Sinny.hooks.common.use-interval")) return fn() end)

newModule("use-mouse-location", "ModuleScript", "Sinny.hooks.common.use-mouse-location", "Sinny.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local useBinding = _roact_hooked.useBinding\
local useEffect = _roact_hooked.useEffect\
...
", '@'.."Sinny.hooks.common.use-mouse-location")) setfenv(fn, newEnv("Sinny.hooks.common.use-mouse-location")) return fn() end)

newModule("use-promise", "ModuleScript", "Sinny.hooks.common.use-promise", "Sinny.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local useEffect = _roact_hooked.useEffect\
...
", '@'.."Sinny.hooks.common.use-promise")) setfenv(fn, newEnv("Sinny.hooks.common.use-promise")) return fn() end)

newModule("use-set-state", "ModuleScript", "Sinny.hooks.common.use-set-state", "Sinny.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.hooks.common.use-set-state")) setfenv(fn, newEnv("Sinny.hooks.common.use-set-state")) return fn() end)

newModule("use-spring", "ModuleScript", "Sinny.hooks.common.use-spring", "Sinny.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Spring = TS.import(script, TS.getModule(script, \"@rbxts\", \"flipper\").src).Spring\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
...
", '@'.."Sinny.hooks.common.use-spring")) setfenv(fn, newEnv("Sinny.hooks.common.use-spring")) return fn() end)

newModule("use-viewport-size", "ModuleScript", "Sinny.hooks.common.use-viewport-size", "Sinny.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local useBinding = _roact_hooked.useBinding\
local useEffect = _roact_hooked.useEffect\
...
", '@'.."Sinny.hooks.common.use-viewport-size")) setfenv(fn, newEnv("Sinny.hooks.common.use-viewport-size")) return fn() end)

newModule("use-current-page", "ModuleScript", "Sinny.hooks.use-current-page", "Sinny.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.hooks.use-current-page")) setfenv(fn, newEnv("Sinny.hooks.use-current-page")) return fn() end)

newModule("use-friends", "ModuleScript", "Sinny.hooks.use-friends", "Sinny.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.hooks.use-friends")) setfenv(fn, newEnv("Sinny.hooks.use-friends")) return fn() end)

newModule("use-parallax-offset", "ModuleScript", "Sinny.hooks.use-parallax-offset", "Sinny.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Spring = TS.import(script, TS.getModule(script, \"@rbxts\", \"flipper\").src).Spring\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
...
", '@'.."Sinny.hooks.use-parallax-offset")) setfenv(fn, newEnv("Sinny.hooks.use-parallax-offset")) return fn() end)

newModule("use-scale", "ModuleScript", "Sinny.hooks.use-scale", "Sinny.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
...
", '@'.."Sinny.hooks.use-scale")) setfenv(fn, newEnv("Sinny.hooks.use-scale")) return fn() end)

newModule("use-theme", "ModuleScript", "Sinny.hooks.use-theme", "Sinny.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local useAppSelector = TS.import(script, script.Parent, \"common\", \"rodux-hooks\").useAppSelector\
...
", '@'.."Sinny.hooks.use-theme")) setfenv(fn, newEnv("Sinny.hooks.use-theme")) return fn() end)

newModule("jobs", "ModuleScript", "Sinny.jobs", "Sinny", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.include.RuntimeLib)\
local exports = {}\
exports.setStore = TS.import(script, script, \"helpers\", \"job-store\").setStore\
return exports\
", '@'.."Sinny.jobs")) setfenv(fn, newEnv("Sinny.jobs")) return fn() end)

newModule("acrylic", "LocalScript", "Sinny.jobs.acrylic", "Sinny.jobs", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Make = TS.import(script, TS.getModule(script, \"@rbxts\", \"make\"))\
...
", '@'.."Sinny.jobs.acrylic")) setfenv(fn, newEnv("Sinny.jobs.acrylic")) return fn() end)

newInstance("character", "Folder", "Sinny.jobs.character", "Sinny.jobs")

newModule("flight", "LocalScript", "Sinny.jobs.character.flight", "Sinny.jobs.character", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _flipper = TS.import(script, TS.getModule(script, \"@rbxts\", \"flipper\").src)\
local GroupMotor = _flipper.GroupMotor\
...
", '@'.."Sinny.jobs.character.flight")) setfenv(fn, newEnv("Sinny.jobs.character.flight")) return fn() end)

newModule("ghost", "LocalScript", "Sinny.jobs.character.ghost", "Sinny.jobs.character", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _services = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\"))\
local Players = _services.Players\
local Workspace = _services.Workspace\
...
", '@'.."Sinny.jobs.character.ghost")) setfenv(fn, newEnv("Sinny.jobs.character.ghost")) return fn() end)

newModule("godmode", "LocalScript", "Sinny.jobs.character.godmode", "Sinny.jobs.character", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _services = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\"))\
local Players = _services.Players\
local Workspace = _services.Workspace\
...
", '@'.."Sinny.jobs.character.godmode")) setfenv(fn, newEnv("Sinny.jobs.character.godmode")) return fn() end)

newModule("humanoid", "LocalScript", "Sinny.jobs.character.humanoid", "Sinny.jobs.character", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Players = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Players\
local _job_store = TS.import(script, script.Parent.Parent, \"helpers\", \"job-store\")\
local getStore = _job_store.getStore\
...
", '@'.."Sinny.jobs.character.humanoid")) setfenv(fn, newEnv("Sinny.jobs.character.humanoid")) return fn() end)

newModule("refresh", "LocalScript", "Sinny.jobs.character.refresh", "Sinny.jobs.character", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _services = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\"))\
local Players = _services.Players\
local Workspace = _services.Workspace\
...
", '@'.."Sinny.jobs.character.refresh")) setfenv(fn, newEnv("Sinny.jobs.character.refresh")) return fn() end)

newModule("freecam", "LocalScript", "Sinny.jobs.freecam", "Sinny.jobs", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.jobs.freecam")) setfenv(fn, newEnv("Sinny.jobs.freecam")) return fn() end)

newInstance("helpers", "Folder", "Sinny.jobs.helpers", "Sinny.jobs")

newModule("freecam", "ModuleScript", "Sinny.jobs.helpers.freecam", "Sinny.jobs.helpers", function () local fn = assert(loadstring("------------------------------------------------------------------------\
-- Freecam\
...
", '@'.."Sinny.jobs.helpers.freecam")) setfenv(fn, newEnv("Sinny.jobs.helpers.freecam")) return fn() end)

newModule("get-selected-player", "ModuleScript", "Sinny.jobs.helpers.get-selected-player", "Sinny.jobs.helpers", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Players = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Players\
...
", '@'.."Sinny.jobs.helpers.get-selected-player")) setfenv(fn, newEnv("Sinny.jobs.helpers.get-selected-player")) return fn() end)

newModule("job-store", "ModuleScript", "Sinny.jobs.helpers.job-store", "Sinny.jobs.helpers", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.jobs.helpers.job-store")) setfenv(fn, newEnv("Sinny.jobs.helpers.job-store")) return fn() end)

newInstance("players", "Folder", "Sinny.jobs.players", "Sinny.jobs")

newModule("hide", "LocalScript", "Sinny.jobs.players.hide", "Sinny.jobs.players", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Players = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Players\
...
", '@'.."Sinny.jobs.players.hide")) setfenv(fn, newEnv("Sinny.jobs.players.hide")) return fn() end)

newModule("kill", "LocalScript", "Sinny.jobs.players.kill", "Sinny.jobs.players", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _services = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\"))\
local Players = _services.Players\
local Workspace = _services.Workspace\
...
", '@'.."Sinny.jobs.players.kill")) setfenv(fn, newEnv("Sinny.jobs.players.kill")) return fn() end)

newModule("spectate", "LocalScript", "Sinny.jobs.players.spectate", "Sinny.jobs.players", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Workspace = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Workspace\
local getSelectedPlayer = TS.import(script, script.Parent.Parent, \"helpers\", \"get-selected-player\").getSelectedPlayer\
local _job_store = TS.import(script, script.Parent.Parent, \"helpers\", \"job-store\")\
...
", '@'.."Sinny.jobs.players.spectate")) setfenv(fn, newEnv("Sinny.jobs.players.spectate")) return fn() end)

newModule("teleport", "LocalScript", "Sinny.jobs.players.teleport", "Sinny.jobs.players", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Players = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Players\
local getSelectedPlayer = TS.import(script, script.Parent.Parent, \"helpers\", \"get-selected-player\").getSelectedPlayer\
local _job_store = TS.import(script, script.Parent.Parent, \"helpers\", \"job-store\")\
...
", '@'.."Sinny.jobs.players.teleport")) setfenv(fn, newEnv("Sinny.jobs.players.teleport")) return fn() end)

newModule("server", "LocalScript", "Sinny.jobs.server", "Sinny.jobs", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local _services = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\"))\
...
\9local code = isRelease and 'loadstring(game:HttpGetAsync(\"https://raw.githubusercontent.com/richie0866/Sinny/master/public/latest.lua\"))()' or 'loadstring(game:HttpGetAsync(\"https://raw.githubusercontent.com/richie0866/Sinny/master/public/snapshot.lua\"))()'\
\9local _result = syn\
\9if _result ~= nil then\
...
", '@'.."Sinny.jobs.server")) setfenv(fn, newEnv("Sinny.jobs.server")) return fn() end)

newModule("main", "LocalScript", "Sinny.main", "Sinny", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.include.RuntimeLib)\
local Make = TS.import(script, TS.getModule(script, \"@rbxts\", \"make\"))\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local Provider = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-rodux-hooked\").out).Provider\
...
local main = TS.async(function()\
\9if getgenv and getgenv()._Sinny_IS_LOADED ~= nil then\
\9\9error(\"Sinny is already loaded!\")\
\9end\
...
\9end\
\9if getgenv then\
\9\9getgenv()._Sinny_IS_LOADED = true\
\9end\
end)\
main():catch(function(err)\
\9warn(\"Sinny failed to load: \" .. tostring(err))\
end)\
", '@'.."Sinny.main")) setfenv(fn, newEnv("Sinny.main")) return fn() end)

newInstance("store", "Folder", "Sinny.store", "Sinny")

newInstance("actions", "Folder", "Sinny.store.actions", "Sinny.store")

newModule("dashboard.action", "ModuleScript", "Sinny.store.actions.dashboard.action", "Sinny.store.actions", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.store.actions.dashboard.action")) setfenv(fn, newEnv("Sinny.store.actions.dashboard.action")) return fn() end)

newModule("jobs.action", "ModuleScript", "Sinny.store.actions.jobs.action", "Sinny.store.actions", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Rodux = TS.import(script, TS.getModule(script, \"@rbxts\", \"rodux\").src)\
...
", '@'.."Sinny.store.actions.jobs.action")) setfenv(fn, newEnv("Sinny.store.actions.jobs.action")) return fn() end)

newModule("options.action", "ModuleScript", "Sinny.store.actions.options.action", "Sinny.store.actions", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Rodux = TS.import(script, TS.getModule(script, \"@rbxts\", \"rodux\").src)\
...
", '@'.."Sinny.store.actions.options.action")) setfenv(fn, newEnv("Sinny.store.actions.options.action")) return fn() end)

newInstance("models", "Folder", "Sinny.store.models", "Sinny.store")

newModule("dashboard.model", "ModuleScript", "Sinny.store.models.dashboard.model", "Sinny.store.models", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local DashboardPage\
do\
\9local _inverse = {}\
...
", '@'.."Sinny.store.models.dashboard.model")) setfenv(fn, newEnv("Sinny.store.models.dashboard.model")) return fn() end)

newModule("jobs.model", "ModuleScript", "Sinny.store.models.jobs.model", "Sinny.store.models", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
", '@'.."Sinny.store.models.jobs.model")) setfenv(fn, newEnv("Sinny.store.models.jobs.model")) return fn() end)

newModule("options.model", "ModuleScript", "Sinny.store.models.options.model", "Sinny.store.models", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
", '@'.."Sinny.store.models.options.model")) setfenv(fn, newEnv("Sinny.store.models.options.model")) return fn() end)

newModule("persistent-state", "ModuleScript", "Sinny.store.persistent-state", "Sinny.store", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local _services = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\"))\
local HttpService = _services.HttpService\
local Players = _services.Players\
...
if makefolder and not isfolder(\"_Sinny\") then\
\9makefolder(\"_Sinny\")\
end\
...
\9\9local serializedState = read(\"_Sinny/\" .. (name .. \".json\"))\
\9\9if serializedState == nil then\
\9\9\9write(\"_Sinny/\" .. (name .. \".json\"), HttpService:JSONEncode(defaultValue))\
...
\9\9write(\"_Sinny/\" .. (name .. \".json\"), HttpService:JSONEncode(state))\
\9end\
...
", '@'.."Sinny.store.persistent-state")) setfenv(fn, newEnv("Sinny.store.persistent-state")) return fn() end)

newInstance("reducers", "Folder", "Sinny.store.reducers", "Sinny.store")

newModule("dashboard.reducer", "ModuleScript", "Sinny.store.reducers.dashboard.reducer", "Sinny.store.reducers", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Rodux = TS.import(script, TS.getModule(script, \"@rbxts\", \"rodux\").src)\
...
", '@'.."Sinny.store.reducers.dashboard.reducer")) setfenv(fn, newEnv("Sinny.store.reducers.dashboard.reducer")) return fn() end)

newModule("jobs.reducer", "ModuleScript", "Sinny.store.reducers.jobs.reducer", "Sinny.store.reducers", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Rodux = TS.import(script, TS.getModule(script, \"@rbxts\", \"rodux\").src)\
local initialState = {\
\9flight = {\
...
", '@'.."Sinny.store.reducers.jobs.reducer")) setfenv(fn, newEnv("Sinny.store.reducers.jobs.reducer")) return fn() end)

newModule("options.reducer", "ModuleScript", "Sinny.store.reducers.options.reducer", "Sinny.store.reducers", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Rodux = TS.import(script, TS.getModule(script, \"@rbxts\", \"rodux\").src)\
...
", '@'.."Sinny.store.reducers.options.reducer")) setfenv(fn, newEnv("Sinny.store.reducers.options.reducer")) return fn() end)

newModule("store", "ModuleScript", "Sinny.store.store", "Sinny.store", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Rodux = TS.import(script, TS.getModule(script, \"@rbxts\", \"rodux\").src)\
...
", '@'.."Sinny.store.store")) setfenv(fn, newEnv("Sinny.store.store")) return fn() end)

newModule("themes", "ModuleScript", "Sinny.themes", "Sinny", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.themes")) setfenv(fn, newEnv("Sinny.themes")) return fn() end)

newModule("dark-theme", "ModuleScript", "Sinny.themes.dark-theme", "Sinny.themes", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local hex = TS.import(script, script.Parent.Parent, \"utils\", \"color3\").hex\
local darkTheme = {\
\9name = \"Dark theme\",\
...
", '@'.."Sinny.themes.dark-theme")) setfenv(fn, newEnv("Sinny.themes.dark-theme")) return fn() end)

newModule("frosted-glass", "ModuleScript", "Sinny.themes.frosted-glass", "Sinny.themes", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.themes.frosted-glass")) setfenv(fn, newEnv("Sinny.themes.frosted-glass")) return fn() end)

newModule("high-contrast", "ModuleScript", "Sinny.themes.high-contrast", "Sinny.themes", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local darkTheme = TS.import(script, script.Parent, \"dark-theme\").darkTheme\
local hex = TS.import(script, script.Parent.Parent, \"utils\", \"color3\").hex\
local _object = {}\
...
", '@'.."Sinny.themes.high-contrast")) setfenv(fn, newEnv("Sinny.themes.high-contrast")) return fn() end)

newModule("light-theme", "ModuleScript", "Sinny.themes.light-theme", "Sinny.themes", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local darkTheme = TS.import(script, script.Parent, \"dark-theme\").darkTheme\
local hex = TS.import(script, script.Parent.Parent, \"utils\", \"color3\").hex\
local _object = {}\
...
", '@'.."Sinny.themes.light-theme")) setfenv(fn, newEnv("Sinny.themes.light-theme")) return fn() end)

newModule("obsidian", "ModuleScript", "Sinny.themes.obsidian", "Sinny.themes", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local darkTheme = TS.import(script, script.Parent, \"dark-theme\").darkTheme\
local hex = TS.import(script, script.Parent.Parent, \"utils\", \"color3\").hex\
...
", '@'.."Sinny.themes.obsidian")) setfenv(fn, newEnv("Sinny.themes.obsidian")) return fn() end)

newModule("sorbet", "ModuleScript", "Sinny.themes.sorbet", "Sinny.themes", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local darkTheme = TS.import(script, script.Parent, \"dark-theme\").darkTheme\
local hex = TS.import(script, script.Parent.Parent, \"utils\", \"color3\").hex\
...
", '@'.."Sinny.themes.sorbet")) setfenv(fn, newEnv("Sinny.themes.sorbet")) return fn() end)

newModule("theme.interface", "ModuleScript", "Sinny.themes.theme.interface", "Sinny.themes", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
", '@'.."Sinny.themes.theme.interface")) setfenv(fn, newEnv("Sinny.themes.theme.interface")) return fn() end)

newInstance("utils", "Folder", "Sinny.utils", "Sinny")

newModule("array-util", "ModuleScript", "Sinny.utils.array-util", "Sinny.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.utils.array-util")) setfenv(fn, newEnv("Sinny.utils.array-util")) return fn() end)

newModule("binding-util", "ModuleScript", "Sinny.utils.binding-util", "Sinny.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
...
", '@'.."Sinny.utils.binding-util")) setfenv(fn, newEnv("Sinny.utils.binding-util")) return fn() end)

newModule("color3", "ModuleScript", "Sinny.utils.color3", "Sinny.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.utils.color3")) setfenv(fn, newEnv("Sinny.utils.color3")) return fn() end)

newModule("debug", "ModuleScript", "Sinny.utils.debug", "Sinny.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.utils.debug")) setfenv(fn, newEnv("Sinny.utils.debug")) return fn() end)

newModule("http", "ModuleScript", "Sinny.utils.http", "Sinny.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.utils.http")) setfenv(fn, newEnv("Sinny.utils.http")) return fn() end)

newModule("number-util", "ModuleScript", "Sinny.utils.number-util", "Sinny.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.utils.number-util")) setfenv(fn, newEnv("Sinny.utils.number-util")) return fn() end)

newModule("timeout", "ModuleScript", "Sinny.utils.timeout", "Sinny.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
...
", '@'.."Sinny.utils.timeout")) setfenv(fn, newEnv("Sinny.utils.timeout")) return fn() end)

newModule("udim2", "ModuleScript", "Sinny.utils.udim2", "Sinny.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.utils.udim2")) setfenv(fn, newEnv("Sinny.utils.udim2")) return fn() end)

newInstance("views", "Folder", "Sinny.views", "Sinny")

newModule("Clock", "ModuleScript", "Sinny.views.Clock", "Sinny.views", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Clock\").default\
return exports\
", '@'.."Sinny.views.Clock")) setfenv(fn, newEnv("Sinny.views.Clock")) return fn() end)

newModule("Clock", "ModuleScript", "Sinny.views.Clock.Clock", "Sinny.views.Clock", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Clock.Clock")) setfenv(fn, newEnv("Sinny.views.Clock.Clock")) return fn() end)

newModule("Dashboard", "ModuleScript", "Sinny.views.Dashboard", "Sinny.views", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Dashboard\").default\
return exports\
", '@'.."Sinny.views.Dashboard")) setfenv(fn, newEnv("Sinny.views.Dashboard")) return fn() end)

newModule("Dashboard", "ModuleScript", "Sinny.views.Dashboard.Dashboard", "Sinny.views.Dashboard", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Dashboard.Dashboard")) setfenv(fn, newEnv("Sinny.views.Dashboard.Dashboard")) return fn() end)

newModule("Dashboard.story", "ModuleScript", "Sinny.views.Dashboard.Dashboard.story", "Sinny.views.Dashboard", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local Provider = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-rodux-hooked\").out).Provider\
local DashboardPage = TS.import(script, script.Parent.Parent.Parent, \"store\", \"models\", \"dashboard.model\").DashboardPage\
...
", '@'.."Sinny.views.Dashboard.Dashboard.story")) setfenv(fn, newEnv("Sinny.views.Dashboard.Dashboard.story")) return fn() end)

newModule("Hint", "ModuleScript", "Sinny.views.Hint", "Sinny.views", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Hint\").default\
return exports\
", '@'.."Sinny.views.Hint")) setfenv(fn, newEnv("Sinny.views.Hint")) return fn() end)

newModule("Hint", "ModuleScript", "Sinny.views.Hint.Hint", "Sinny.views.Hint", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Hint.Hint")) setfenv(fn, newEnv("Sinny.views.Hint.Hint")) return fn() end)

newModule("Navbar", "ModuleScript", "Sinny.views.Navbar", "Sinny.views", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Navbar\").default\
return exports\
", '@'.."Sinny.views.Navbar")) setfenv(fn, newEnv("Sinny.views.Navbar")) return fn() end)

newModule("Navbar", "ModuleScript", "Sinny.views.Navbar.Navbar", "Sinny.views.Navbar", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Acrylic = TS.import(script, script.Parent.Parent.Parent, \"components\", \"Acrylic\").default\
...
", '@'.."Sinny.views.Navbar.Navbar")) setfenv(fn, newEnv("Sinny.views.Navbar.Navbar")) return fn() end)

newModule("Navbar.story", "ModuleScript", "Sinny.views.Navbar.Navbar.story", "Sinny.views.Navbar", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local Provider = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-rodux-hooked\").out).Provider\
local DashboardPage = TS.import(script, script.Parent.Parent.Parent, \"store\", \"models\", \"dashboard.model\").DashboardPage\
...
", '@'.."Sinny.views.Navbar.Navbar.story")) setfenv(fn, newEnv("Sinny.views.Navbar.Navbar.story")) return fn() end)

newModule("NavbarTab", "ModuleScript", "Sinny.views.Navbar.NavbarTab", "Sinny.views.Navbar", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Navbar.NavbarTab")) setfenv(fn, newEnv("Sinny.views.Navbar.NavbarTab")) return fn() end)

newModule("Pages", "ModuleScript", "Sinny.views.Pages", "Sinny.views", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Pages\").default\
return exports\
", '@'.."Sinny.views.Pages")) setfenv(fn, newEnv("Sinny.views.Pages")) return fn() end)

newModule("Apps", "ModuleScript", "Sinny.views.Pages.Apps", "Sinny.views.Pages", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Apps\").default\
return exports\
", '@'.."Sinny.views.Pages.Apps")) setfenv(fn, newEnv("Sinny.views.Pages.Apps")) return fn() end)

newModule("Apps", "ModuleScript", "Sinny.views.Pages.Apps.Apps", "Sinny.views.Pages.Apps", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
...
", '@'.."Sinny.views.Pages.Apps.Apps")) setfenv(fn, newEnv("Sinny.views.Pages.Apps.Apps")) return fn() end)

newModule("Players", "ModuleScript", "Sinny.views.Pages.Apps.Players", "Sinny.views.Pages.Apps", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Players\").default\
return exports\
", '@'.."Sinny.views.Pages.Apps.Players")) setfenv(fn, newEnv("Sinny.views.Pages.Apps.Players")) return fn() end)

newModule("Actions", "ModuleScript", "Sinny.views.Pages.Apps.Players.Actions", "Sinny.views.Pages.Apps.Players", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.views.Pages.Apps.Players.Actions")) setfenv(fn, newEnv("Sinny.views.Pages.Apps.Players.Actions")) return fn() end)

newModule("Avatar", "ModuleScript", "Sinny.views.Pages.Apps.Players.Avatar", "Sinny.views.Pages.Apps.Players", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Players = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Players\
...
", '@'.."Sinny.views.Pages.Apps.Players.Avatar")) setfenv(fn, newEnv("Sinny.views.Pages.Apps.Players.Avatar")) return fn() end)

newModule("Players", "ModuleScript", "Sinny.views.Pages.Apps.Players.Players", "Sinny.views.Pages.Apps.Players", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
...
", '@'.."Sinny.views.Pages.Apps.Players.Players")) setfenv(fn, newEnv("Sinny.views.Pages.Apps.Players.Players")) return fn() end)

newModule("Selection", "ModuleScript", "Sinny.views.Pages.Apps.Players.Selection", "Sinny.views.Pages.Apps.Players", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Pages.Apps.Players.Selection")) setfenv(fn, newEnv("Sinny.views.Pages.Apps.Players.Selection")) return fn() end)

newModule("Username", "ModuleScript", "Sinny.views.Pages.Apps.Players.Username", "Sinny.views.Pages.Apps.Players", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Players = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Players\
...
", '@'.."Sinny.views.Pages.Apps.Players.Username")) setfenv(fn, newEnv("Sinny.views.Pages.Apps.Players.Username")) return fn() end)

newModule("Home", "ModuleScript", "Sinny.views.Pages.Home", "Sinny.views.Pages", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Home\").default\
return exports\
", '@'.."Sinny.views.Pages.Home")) setfenv(fn, newEnv("Sinny.views.Pages.Home")) return fn() end)

newModule("FriendActivity", "ModuleScript", "Sinny.views.Pages.Home.FriendActivity", "Sinny.views.Pages.Home", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"FriendActivity\").default\
return exports\
", '@'.."Sinny.views.Pages.Home.FriendActivity")) setfenv(fn, newEnv("Sinny.views.Pages.Home.FriendActivity")) return fn() end)

newModule("FriendActivity", "ModuleScript", "Sinny.views.Pages.Home.FriendActivity.FriendActivity", "Sinny.views.Pages.Home.FriendActivity", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Pages.Home.FriendActivity.FriendActivity")) setfenv(fn, newEnv("Sinny.views.Pages.Home.FriendActivity.FriendActivity")) return fn() end)

newModule("FriendItem", "ModuleScript", "Sinny.views.Pages.Home.FriendActivity.FriendItem", "Sinny.views.Pages.Home.FriendActivity", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Pages.Home.FriendActivity.FriendItem")) setfenv(fn, newEnv("Sinny.views.Pages.Home.FriendActivity.FriendItem")) return fn() end)

newModule("GameItem", "ModuleScript", "Sinny.views.Pages.Home.FriendActivity.GameItem", "Sinny.views.Pages.Home.FriendActivity", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
...
", '@'.."Sinny.views.Pages.Home.FriendActivity.GameItem")) setfenv(fn, newEnv("Sinny.views.Pages.Home.FriendActivity.GameItem")) return fn() end)

newModule("Home", "ModuleScript", "Sinny.views.Pages.Home.Home", "Sinny.views.Pages.Home", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local pure = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).pure\
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent, \"components\", \"Canvas\").default\
...
", '@'.."Sinny.views.Pages.Home.Home")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Home")) return fn() end)

newModule("Profile", "ModuleScript", "Sinny.views.Pages.Home.Profile", "Sinny.views.Pages.Home", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Profile\").default\
return exports\
", '@'.."Sinny.views.Pages.Home.Profile")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Profile")) return fn() end)

newModule("Actions", "ModuleScript", "Sinny.views.Pages.Home.Profile.Actions", "Sinny.views.Pages.Home.Profile", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local ActionButton = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, \"components\", \"ActionButton\").default\
...
", '@'.."Sinny.views.Pages.Home.Profile.Actions")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Profile.Actions")) return fn() end)

newModule("Avatar", "ModuleScript", "Sinny.views.Pages.Home.Profile.Avatar", "Sinny.views.Pages.Home.Profile", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Players = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Players\
...
", '@'.."Sinny.views.Pages.Home.Profile.Avatar")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Profile.Avatar")) return fn() end)

newModule("Info", "ModuleScript", "Sinny.views.Pages.Home.Profile.Info", "Sinny.views.Pages.Home.Profile", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Players = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Players\
...
", '@'.."Sinny.views.Pages.Home.Profile.Info")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Profile.Info")) return fn() end)

newModule("Profile", "ModuleScript", "Sinny.views.Pages.Home.Profile.Profile", "Sinny.views.Pages.Home.Profile", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, \"components\", \"Canvas\").default\
...
", '@'.."Sinny.views.Pages.Home.Profile.Profile")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Profile.Profile")) return fn() end)

newModule("Sliders", "ModuleScript", "Sinny.views.Pages.Home.Profile.Sliders", "Sinny.views.Pages.Home.Profile", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Pages.Home.Profile.Sliders")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Profile.Sliders")) return fn() end)

newModule("Username", "ModuleScript", "Sinny.views.Pages.Home.Profile.Username", "Sinny.views.Pages.Home.Profile", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Players = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Players\
...
", '@'.."Sinny.views.Pages.Home.Profile.Username")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Profile.Username")) return fn() end)

newModule("Server", "ModuleScript", "Sinny.views.Pages.Home.Server", "Sinny.views.Pages.Home", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Server\").default\
return exports\
", '@'.."Sinny.views.Pages.Home.Server")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Server")) return fn() end)

newModule("Server", "ModuleScript", "Sinny.views.Pages.Home.Server.Server", "Sinny.views.Pages.Home.Server", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Players = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Players\
...
", '@'.."Sinny.views.Pages.Home.Server.Server")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Server.Server")) return fn() end)

newModule("ServerAction", "ModuleScript", "Sinny.views.Pages.Home.Server.ServerAction", "Sinny.views.Pages.Home.Server", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Pages.Home.Server.ServerAction")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Server.ServerAction")) return fn() end)

newModule("StatusLabel", "ModuleScript", "Sinny.views.Pages.Home.Server.StatusLabel", "Sinny.views.Pages.Home.Server", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Pages.Home.Server.StatusLabel")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Server.StatusLabel")) return fn() end)

newModule("Title", "ModuleScript", "Sinny.views.Pages.Home.Title", "Sinny.views.Pages.Home", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent, \"components\", \"Canvas\").default\
...
", '@'.."Sinny.views.Pages.Home.Title")) setfenv(fn, newEnv("Sinny.views.Pages.Home.Title")) return fn() end)

newModule("Options", "ModuleScript", "Sinny.views.Pages.Options", "Sinny.views.Pages", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Options\").default\
return exports\
", '@'.."Sinny.views.Pages.Options")) setfenv(fn, newEnv("Sinny.views.Pages.Options")) return fn() end)

newModule("Config", "ModuleScript", "Sinny.views.Pages.Options.Config", "Sinny.views.Pages.Options", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Config\").default\
return exports\
", '@'.."Sinny.views.Pages.Options.Config")) setfenv(fn, newEnv("Sinny.views.Pages.Options.Config")) return fn() end)

newModule("Config", "ModuleScript", "Sinny.views.Pages.Options.Config.Config", "Sinny.views.Pages.Options.Config", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, \"components\", \"Canvas\").default\
...
", '@'.."Sinny.views.Pages.Options.Config.Config")) setfenv(fn, newEnv("Sinny.views.Pages.Options.Config.Config")) return fn() end)

newModule("ConfigItem", "ModuleScript", "Sinny.views.Pages.Options.Config.ConfigItem", "Sinny.views.Pages.Options.Config", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local pure = _roact_hooked.pure\
...
", '@'.."Sinny.views.Pages.Options.Config.ConfigItem")) setfenv(fn, newEnv("Sinny.views.Pages.Options.Config.ConfigItem")) return fn() end)

newModule("Options", "ModuleScript", "Sinny.views.Pages.Options.Options", "Sinny.views.Pages.Options", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local pure = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).pure\
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent, \"components\", \"Canvas\").default\
...
", '@'.."Sinny.views.Pages.Options.Options")) setfenv(fn, newEnv("Sinny.views.Pages.Options.Options")) return fn() end)

newModule("Shortcuts", "ModuleScript", "Sinny.views.Pages.Options.Shortcuts", "Sinny.views.Pages.Options", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Shortcuts\").default\
return exports\
", '@'.."Sinny.views.Pages.Options.Shortcuts")) setfenv(fn, newEnv("Sinny.views.Pages.Options.Shortcuts")) return fn() end)

newModule("ShortcutItem", "ModuleScript", "Sinny.views.Pages.Options.Shortcuts.ShortcutItem", "Sinny.views.Pages.Options.Shortcuts", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local pure = _roact_hooked.pure\
...
", '@'.."Sinny.views.Pages.Options.Shortcuts.ShortcutItem")) setfenv(fn, newEnv("Sinny.views.Pages.Options.Shortcuts.ShortcutItem")) return fn() end)

newModule("Shortcuts", "ModuleScript", "Sinny.views.Pages.Options.Shortcuts.Shortcuts", "Sinny.views.Pages.Options.Shortcuts", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
\9\9\9\9\9description = \"Open Sinny\",\
\9\9\9\9\9index = 0,\
\9\9\9\9}),\
\9\9\9\9Roact.createElement(ShortcutItem, {\
\9\9\9\9\9onActivate = function()\
...
", '@'.."Sinny.views.Pages.Options.Shortcuts.Shortcuts")) setfenv(fn, newEnv("Sinny.views.Pages.Options.Shortcuts.Shortcuts")) return fn() end)

newModule("Themes", "ModuleScript", "Sinny.views.Pages.Options.Themes", "Sinny.views.Pages.Options", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Themes\").default\
return exports\
", '@'.."Sinny.views.Pages.Options.Themes")) setfenv(fn, newEnv("Sinny.views.Pages.Options.Themes")) return fn() end)

newModule("ThemeItem", "ModuleScript", "Sinny.views.Pages.Options.Themes.ThemeItem", "Sinny.views.Pages.Options.Themes", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Pages.Options.Themes.ThemeItem")) setfenv(fn, newEnv("Sinny.views.Pages.Options.Themes.ThemeItem")) return fn() end)

newModule("Themes", "ModuleScript", "Sinny.views.Pages.Options.Themes.Themes", "Sinny.views.Pages.Options.Themes", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Pages.Options.Themes.Themes")) setfenv(fn, newEnv("Sinny.views.Pages.Options.Themes.Themes")) return fn() end)

newModule("Pages", "ModuleScript", "Sinny.views.Pages.Pages", "Sinny.views.Pages", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local useDelayedUpdate = TS.import(script, script.Parent.Parent.Parent, \"hooks\", \"common\", \"use-delayed-update\").useDelayedUpdate\
...
", '@'.."Sinny.views.Pages.Pages")) setfenv(fn, newEnv("Sinny.views.Pages.Pages")) return fn() end)

newModule("Scripts", "ModuleScript", "Sinny.views.Pages.Scripts", "Sinny.views.Pages", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
exports.default = TS.import(script, script, \"Scripts\").default\
return exports\
", '@'.."Sinny.views.Pages.Scripts")) setfenv(fn, newEnv("Sinny.views.Pages.Scripts")) return fn() end)

newModule("Content", "ModuleScript", "Sinny.views.Pages.Scripts.Content", "Sinny.views.Pages.Scripts", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent, \"components\", \"Canvas\").default\
...
", '@'.."Sinny.views.Pages.Scripts.Content")) setfenv(fn, newEnv("Sinny.views.Pages.Scripts.Content")) return fn() end)

newModule("ScriptCard", "ModuleScript", "Sinny.views.Pages.Scripts.ScriptCard", "Sinny.views.Pages.Scripts", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
", '@'.."Sinny.views.Pages.Scripts.ScriptCard")) setfenv(fn, newEnv("Sinny.views.Pages.Scripts.ScriptCard")) return fn() end)

newModule("Scripts", "ModuleScript", "Sinny.views.Pages.Scripts.Scripts", "Sinny.views.Pages.Scripts", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local pure = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).pure\
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent, \"components\", \"Canvas\").default\
...
", '@'.."Sinny.views.Pages.Scripts.Scripts")) setfenv(fn, newEnv("Sinny.views.Pages.Scripts.Scripts")) return fn() end)

newModule("constants", "ModuleScript", "Sinny.views.Pages.Scripts.constants", "Sinny.views.Pages.Scripts", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.views.Pages.Scripts.constants")) setfenv(fn, newEnv("Sinny.views.Pages.Scripts.constants")) return fn() end)

newInstance("include", "Folder", "Sinny.include", "Sinny")

newModule("Promise", "ModuleScript", "Sinny.include.Promise", "Sinny.include", function () local fn = assert(loadstring("--[[\
...
\
return Promise\
", '@'.."Sinny.include.Promise")) setfenv(fn, newEnv("Sinny.include.Promise")) return fn() end)

newModule("RuntimeLib", "ModuleScript", "Sinny.include.RuntimeLib", "Sinny.include", function () local fn = assert(loadstring("local Promise = require(script.Parent.Promise)\
\
local RunService = game:GetService(\"RunService\")\
...
\
return TS\
", '@'.."Sinny.include.RuntimeLib")) setfenv(fn, newEnv("Sinny.include.RuntimeLib")) return fn() end)

newInstance("node_modules", "Folder", "Sinny.include.node_modules", "Sinny.include")

newInstance("compiler-types", "Folder", "Sinny.include.node_modules.compiler-types", "Sinny.include.node_modules")

newInstance("types", "Folder", "Sinny.include.node_modules.compiler-types.types", "Sinny.include.node_modules.compiler-types")

newInstance("exploit-types", "Folder", "Sinny.include.node_modules.exploit-types", "Sinny.include.node_modules")

newInstance("types", "Folder", "Sinny.include.node_modules.exploit-types.types", "Sinny.include.node_modules.exploit-types")

newInstance("flipper", "Folder", "Sinny.include.node_modules.flipper", "Sinny.include.node_modules")

newModule("src", "ModuleScript", "Sinny.include.node_modules.flipper.src", "Sinny.include.node_modules.flipper", function () local fn = assert(loadstring("local Flipper = {\13\
...
\13\
return Flipper", '@'.."Sinny.include.node_modules.flipper.src")) setfenv(fn, newEnv("Sinny.include.node_modules.flipper.src")) return fn() end)

newModule("BaseMotor", "ModuleScript", "Sinny.include.node_modules.flipper.src.BaseMotor", "Sinny.include.node_modules.flipper.src", function () local fn = assert(loadstring("local RunService = game:GetService(\"RunService\")\13\
\13\
...
\13\
return BaseMotor\13\
", '@'.."Sinny.include.node_modules.flipper.src.BaseMotor")) setfenv(fn, newEnv("Sinny.include.node_modules.flipper.src.BaseMotor")) return fn() end)

newModule("GroupMotor", "ModuleScript", "Sinny.include.node_modules.flipper.src.GroupMotor", "Sinny.include.node_modules.flipper.src", function () local fn = assert(loadstring("local BaseMotor = require(script.Parent.BaseMotor)\13\
...
", '@'.."Sinny.include.node_modules.flipper.src.GroupMotor")) setfenv(fn, newEnv("Sinny.include.node_modules.flipper.src.GroupMotor")) return fn() end)

newModule("Instant", "ModuleScript", "Sinny.include.node_modules.flipper.src.Instant", "Sinny.include.node_modules.flipper.src", function () local fn = assert(loadstring("local Instant = {}\13\
...
\13\
return Instant", '@'.."Sinny.include.node_modules.flipper.src.Instant")) setfenv(fn, newEnv("Sinny.include.node_modules.flipper.src.Instant")) return fn() end)

newModule("Linear", "ModuleScript", "Sinny.include.node_modules.flipper.src.Linear", "Sinny.include.node_modules.flipper.src", function () local fn = assert(loadstring("local Linear = {}\13\
...
\13\
return Linear", '@'.."Sinny.include.node_modules.flipper.src.Linear")) setfenv(fn, newEnv("Sinny.include.node_modules.flipper.src.Linear")) return fn() end)

newModule("Signal", "ModuleScript", "Sinny.include.node_modules.flipper.src.Signal", "Sinny.include.node_modules.flipper.src", function () local fn = assert(loadstring("local Connection = {}\13\
...
\13\
return Signal", '@'.."Sinny.include.node_modules.flipper.src.Signal")) setfenv(fn, newEnv("Sinny.include.node_modules.flipper.src.Signal")) return fn() end)

newModule("SingleMotor", "ModuleScript", "Sinny.include.node_modules.flipper.src.SingleMotor", "Sinny.include.node_modules.flipper.src", function () local fn = assert(loadstring("local BaseMotor = require(script.Parent.BaseMotor)\13\
\13\
...
", '@'.."Sinny.include.node_modules.flipper.src.SingleMotor")) setfenv(fn, newEnv("Sinny.include.node_modules.flipper.src.SingleMotor")) return fn() end)

newModule("Spring", "ModuleScript", "Sinny.include.node_modules.flipper.src.Spring", "Sinny.include.node_modules.flipper.src", function () local fn = assert(loadstring("local VELOCITY_THRESHOLD = 0.001\13\
...
\13\
return Spring", '@'.."Sinny.include.node_modules.flipper.src.Spring")) setfenv(fn, newEnv("Sinny.include.node_modules.flipper.src.Spring")) return fn() end)

newModule("isMotor", "ModuleScript", "Sinny.include.node_modules.flipper.src.isMotor", "Sinny.include.node_modules.flipper.src", function () local fn = assert(loadstring("local function isMotor(value)\13\
...
\13\
return isMotor", '@'.."Sinny.include.node_modules.flipper.src.isMotor")) setfenv(fn, newEnv("Sinny.include.node_modules.flipper.src.isMotor")) return fn() end)

newInstance("typings", "Folder", "Sinny.include.node_modules.flipper.typings", "Sinny.include.node_modules.flipper")

newModule("make", "ModuleScript", "Sinny.include.node_modules.make", "Sinny.include.node_modules", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
--[[\
\9*\
...
return Make\
", '@'.."Sinny.include.node_modules.make")) setfenv(fn, newEnv("Sinny.include.node_modules.make")) return fn() end)

newInstance("node_modules", "Folder", "Sinny.include.node_modules.make.node_modules", "Sinny.include.node_modules.make")

newInstance("@rbxts", "Folder", "Sinny.include.node_modules.make.node_modules.@rbxts", "Sinny.include.node_modules.make.node_modules")

newInstance("compiler-types", "Folder", "Sinny.include.node_modules.make.node_modules.@rbxts.compiler-types", "Sinny.include.node_modules.make.node_modules.@rbxts")

newInstance("types", "Folder", "Sinny.include.node_modules.make.node_modules.@rbxts.compiler-types.types", "Sinny.include.node_modules.make.node_modules.@rbxts.compiler-types")

newModule("object-utils", "ModuleScript", "Sinny.include.node_modules.object-utils", "Sinny.include.node_modules", function () local fn = assert(loadstring("local HttpService = game:GetService(\"HttpService\")\
\
local Object = {}\
\
...
\
return Object\
", '@'.."Sinny.include.node_modules.object-utils")) setfenv(fn, newEnv("Sinny.include.node_modules.object-utils")) return fn() end)

newInstance("roact", "Folder", "Sinny.include.node_modules.roact", "Sinny.include.node_modules")

newModule("src", "ModuleScript", "Sinny.include.node_modules.roact.src", "Sinny.include.node_modules.roact", function () local fn = assert(loadstring("--[[\
...
\
return Roact", '@'.."Sinny.include.node_modules.roact.src")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src")) return fn() end)

newModule("Binding", "ModuleScript", "Sinny.include.node_modules.roact.src.Binding", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local createSignal = require(script.Parent.createSignal)\
...
\
return BindingInternalApi", '@'.."Sinny.include.node_modules.roact.src.Binding")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.Binding")) return fn() end)

newModule("Component", "ModuleScript", "Sinny.include.node_modules.roact.src.Component", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local assign = require(script.Parent.assign)\
...
\
return Component", '@'.."Sinny.include.node_modules.roact.src.Component")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.Component")) return fn() end)

newModule("ComponentLifecyclePhase", "ModuleScript", "Sinny.include.node_modules.roact.src.ComponentLifecyclePhase", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local Symbol = require(script.Parent.Symbol)\
...
\
return ComponentLifecyclePhase", '@'.."Sinny.include.node_modules.roact.src.ComponentLifecyclePhase")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.ComponentLifecyclePhase")) return fn() end)

newModule("Config", "ModuleScript", "Sinny.include.node_modules.roact.src.Config", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return Config", '@'.."Sinny.include.node_modules.roact.src.Config")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.Config")) return fn() end)

newModule("ElementKind", "ModuleScript", "Sinny.include.node_modules.roact.src.ElementKind", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return ElementKind", '@'.."Sinny.include.node_modules.roact.src.ElementKind")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.ElementKind")) return fn() end)

newModule("ElementUtils", "ModuleScript", "Sinny.include.node_modules.roact.src.ElementUtils", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local Type = require(script.Parent.Type)\
local Symbol = require(script.Parent.Symbol)\
\
local function noop()\
\9return nil\
...
\
return ElementUtils", '@'.."Sinny.include.node_modules.roact.src.ElementUtils")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.ElementUtils")) return fn() end)

newModule("GlobalConfig", "ModuleScript", "Sinny.include.node_modules.roact.src.GlobalConfig", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
\9Exposes a single instance of a configuration as Roact's GlobalConfig.\
]]\
\
local Config = require(script.Parent.Config)\
\
return Config.new()", '@'.."Sinny.include.node_modules.roact.src.GlobalConfig")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.GlobalConfig")) return fn() end)

newModule("Logging", "ModuleScript", "Sinny.include.node_modules.roact.src.Logging", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return Logging", '@'.."Sinny.include.node_modules.roact.src.Logging")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.Logging")) return fn() end)

newModule("None", "ModuleScript", "Sinny.include.node_modules.roact.src.None", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local Symbol = require(script.Parent.Symbol)\
\
-- Marker used to specify that the value is nothing, because nil cannot be\
-- stored in tables.\
local None = Symbol.named(\"None\")\
\
return None", '@'.."Sinny.include.node_modules.roact.src.None")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.None")) return fn() end)

newModule("NoopRenderer", "ModuleScript", "Sinny.include.node_modules.roact.src.NoopRenderer", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return NoopRenderer", '@'.."Sinny.include.node_modules.roact.src.NoopRenderer")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.NoopRenderer")) return fn() end)

newModule("Portal", "ModuleScript", "Sinny.include.node_modules.roact.src.Portal", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local Symbol = require(script.Parent.Symbol)\
\
local Portal = Symbol.named(\"Portal\")\
\
return Portal", '@'.."Sinny.include.node_modules.roact.src.Portal")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.Portal")) return fn() end)

newInstance("PropMarkers", "Folder", "Sinny.include.node_modules.roact.src.PropMarkers", "Sinny.include.node_modules.roact.src")

newModule("Change", "ModuleScript", "Sinny.include.node_modules.roact.src.PropMarkers.Change", "Sinny.include.node_modules.roact.src.PropMarkers", function () local fn = assert(loadstring("--[[\
...
\
return Change\
", '@'.."Sinny.include.node_modules.roact.src.PropMarkers.Change")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.PropMarkers.Change")) return fn() end)

newModule("Children", "ModuleScript", "Sinny.include.node_modules.roact.src.PropMarkers.Children", "Sinny.include.node_modules.roact.src.PropMarkers", function () local fn = assert(loadstring("local Symbol = require(script.Parent.Parent.Symbol)\
\
local Children = Symbol.named(\"Children\")\
\
return Children", '@'.."Sinny.include.node_modules.roact.src.PropMarkers.Children")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.PropMarkers.Children")) return fn() end)

newModule("Event", "ModuleScript", "Sinny.include.node_modules.roact.src.PropMarkers.Event", "Sinny.include.node_modules.roact.src.PropMarkers", function () local fn = assert(loadstring("--[[\
...
\
return Event\
", '@'.."Sinny.include.node_modules.roact.src.PropMarkers.Event")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.PropMarkers.Event")) return fn() end)

newModule("Ref", "ModuleScript", "Sinny.include.node_modules.roact.src.PropMarkers.Ref", "Sinny.include.node_modules.roact.src.PropMarkers", function () local fn = assert(loadstring("local Symbol = require(script.Parent.Parent.Symbol)\
\
local Ref = Symbol.named(\"Ref\")\
\
return Ref", '@'.."Sinny.include.node_modules.roact.src.PropMarkers.Ref")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.PropMarkers.Ref")) return fn() end)

newModule("PureComponent", "ModuleScript", "Sinny.include.node_modules.roact.src.PureComponent", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return PureComponent", '@'.."Sinny.include.node_modules.roact.src.PureComponent")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.PureComponent")) return fn() end)

newModule("RobloxRenderer", "ModuleScript", "Sinny.include.node_modules.roact.src.RobloxRenderer", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
", '@'.."Sinny.include.node_modules.roact.src.RobloxRenderer")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.RobloxRenderer")) return fn() end)

newModule("SingleEventManager", "ModuleScript", "Sinny.include.node_modules.roact.src.SingleEventManager", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return SingleEventManager", '@'.."Sinny.include.node_modules.roact.src.SingleEventManager")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.SingleEventManager")) return fn() end)

newModule("Symbol", "ModuleScript", "Sinny.include.node_modules.roact.src.Symbol", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return Symbol", '@'.."Sinny.include.node_modules.roact.src.Symbol")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.Symbol")) return fn() end)

newModule("Type", "ModuleScript", "Sinny.include.node_modules.roact.src.Type", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return Type", '@'.."Sinny.include.node_modules.roact.src.Type")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.Type")) return fn() end)

newModule("assertDeepEqual", "ModuleScript", "Sinny.include.node_modules.roact.src.assertDeepEqual", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return assertDeepEqual", '@'.."Sinny.include.node_modules.roact.src.assertDeepEqual")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.assertDeepEqual")) return fn() end)

newModule("assign", "ModuleScript", "Sinny.include.node_modules.roact.src.assign", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local None = require(script.Parent.None)\
\
--[[\
...
\
return assign", '@'.."Sinny.include.node_modules.roact.src.assign")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.assign")) return fn() end)

newModule("createContext", "ModuleScript", "Sinny.include.node_modules.roact.src.createContext", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local Symbol = require(script.Parent.Symbol)\
...
", '@'.."Sinny.include.node_modules.roact.src.createContext")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.createContext")) return fn() end)

newModule("createElement", "ModuleScript", "Sinny.include.node_modules.roact.src.createElement", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local Children = require(script.Parent.PropMarkers.Children)\
local ElementKind = require(script.Parent.ElementKind)\
local Logging = require(script.Parent.Logging)\
local Type = require(script.Parent.Type)\
\
...
\
return createElement", '@'.."Sinny.include.node_modules.roact.src.createElement")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.createElement")) return fn() end)

newModule("createFragment", "ModuleScript", "Sinny.include.node_modules.roact.src.createFragment", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local ElementKind = require(script.Parent.ElementKind)\
local Type = require(script.Parent.Type)\
\
...
\
return createFragment", '@'.."Sinny.include.node_modules.roact.src.createFragment")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.createFragment")) return fn() end)

newModule("createReconciler", "ModuleScript", "Sinny.include.node_modules.roact.src.createReconciler", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local Type = require(script.Parent.Type)\
local ElementKind = require(script.Parent.ElementKind)\
...
", '@'.."Sinny.include.node_modules.roact.src.createReconciler")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.createReconciler")) return fn() end)

newModule("createReconcilerCompat", "ModuleScript", "Sinny.include.node_modules.roact.src.createReconcilerCompat", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return createReconcilerCompat", '@'.."Sinny.include.node_modules.roact.src.createReconcilerCompat")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.createReconcilerCompat")) return fn() end)

newModule("createRef", "ModuleScript", "Sinny.include.node_modules.roact.src.createRef", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return createRef", '@'.."Sinny.include.node_modules.roact.src.createRef")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.createRef")) return fn() end)

newModule("createSignal", "ModuleScript", "Sinny.include.node_modules.roact.src.createSignal", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return createSignal\
", '@'.."Sinny.include.node_modules.roact.src.createSignal")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.createSignal")) return fn() end)

newModule("createSpy", "ModuleScript", "Sinny.include.node_modules.roact.src.createSpy", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return createSpy", '@'.."Sinny.include.node_modules.roact.src.createSpy")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.createSpy")) return fn() end)

newModule("forwardRef", "ModuleScript", "Sinny.include.node_modules.roact.src.forwardRef", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local assign = require(script.Parent.assign)\
...
\
return forwardRef", '@'.."Sinny.include.node_modules.roact.src.forwardRef")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.forwardRef")) return fn() end)

newModule("getDefaultInstanceProperty", "ModuleScript", "Sinny.include.node_modules.roact.src.getDefaultInstanceProperty", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return getDefaultInstanceProperty", '@'.."Sinny.include.node_modules.roact.src.getDefaultInstanceProperty")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.getDefaultInstanceProperty")) return fn() end)

newModule("internalAssert", "ModuleScript", "Sinny.include.node_modules.roact.src.internalAssert", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local function internalAssert(condition, message)\
\9if not condition then\
\9\9error(message .. \" (This is probably a bug in Roact!)\", 3)\
\9end\
end\
\
return internalAssert", '@'.."Sinny.include.node_modules.roact.src.internalAssert")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.internalAssert")) return fn() end)

newModule("invalidSetStateMessages", "ModuleScript", "Sinny.include.node_modules.roact.src.invalidSetStateMessages", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return invalidSetStateMessages", '@'.."Sinny.include.node_modules.roact.src.invalidSetStateMessages")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.invalidSetStateMessages")) return fn() end)

newModule("oneChild", "ModuleScript", "Sinny.include.node_modules.roact.src.oneChild", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return oneChild", '@'.."Sinny.include.node_modules.roact.src.oneChild")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.oneChild")) return fn() end)

newModule("strict", "ModuleScript", "Sinny.include.node_modules.roact.src.strict", "Sinny.include.node_modules.roact.src", function () local fn = assert(loadstring("local function strict(t, name)\
...
\
return strict", '@'.."Sinny.include.node_modules.roact.src.strict")) setfenv(fn, newEnv("Sinny.include.node_modules.roact.src.strict")) return fn() end)

newInstance("roact-hooked", "Folder", "Sinny.include.node_modules.roact-hooked", "Sinny.include.node_modules")

newModule("out", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out", "Sinny.include.node_modules.roact-hooked", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
local exports = {}\
...
exports.pure = pure\
return exports\
", '@'.."Sinny.include.node_modules.roact-hooked.out")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out")) return fn() end)

newModule("hooks", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.hooks", "Sinny.include.node_modules.roact-hooked.out", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
local exports = {}\
...
return exports\
", '@'.."Sinny.include.node_modules.roact-hooked.out.hooks")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.hooks")) return fn() end)

newModule("use-binding", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.hooks.use-binding", "Sinny.include.node_modules.roact-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
local createBinding = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src).createBinding\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.hooks.use-binding")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.hooks.use-binding")) return fn() end)

newModule("use-callback", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.hooks.use-callback", "Sinny.include.node_modules.roact-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.hooks.use-callback")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.hooks.use-callback")) return fn() end)

newModule("use-context", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.hooks.use-context", "Sinny.include.node_modules.roact-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
--[[\
\9*\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.hooks.use-context")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.hooks.use-context")) return fn() end)

newModule("use-effect", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.hooks.use-effect", "Sinny.include.node_modules.roact-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.hooks.use-effect")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.hooks.use-effect")) return fn() end)

newModule("use-memo", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.hooks.use-memo", "Sinny.include.node_modules.roact-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
local areDepsEqual = TS.import(script, script.Parent.Parent, \"utils\", \"are-deps-equal\").areDepsEqual\
local memoizedHook = TS.import(script, script.Parent.Parent, \"utils\", \"memoized-hook\").memoizedHook\
--[[\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.hooks.use-memo")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.hooks.use-memo")) return fn() end)

newModule("use-mutable", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.hooks.use-mutable", "Sinny.include.node_modules.roact-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
local memoizedHook = TS.import(script, script.Parent.Parent, \"utils\", \"memoized-hook\").memoizedHook\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.hooks.use-mutable")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.hooks.use-mutable")) return fn() end)

newModule("use-reducer", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.hooks.use-reducer", "Sinny.include.node_modules.roact-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
local _memoized_hook = TS.import(script, script.Parent.Parent, \"utils\", \"memoized-hook\")\
local memoizedHook = _memoized_hook.memoizedHook\
local resolveCurrentComponent = _memoized_hook.resolveCurrentComponent\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.hooks.use-reducer")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.hooks.use-reducer")) return fn() end)

newModule("use-ref", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.hooks.use-ref", "Sinny.include.node_modules.roact-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.hooks.use-ref")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.hooks.use-ref")) return fn() end)

newModule("use-state", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.hooks.use-state", "Sinny.include.node_modules.roact-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.hooks.use-state")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.hooks.use-state")) return fn() end)

newModule("types", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.types", "Sinny.include.node_modules.roact-hooked.out", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
-- Roact\
-- Reducers\
-- Utility types\
-- Hooks\
return nil\
", '@'.."Sinny.include.node_modules.roact-hooked.out.types")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.types")) return fn() end)

newInstance("utils", "Folder", "Sinny.include.node_modules.roact-hooked.out.utils", "Sinny.include.node_modules.roact-hooked.out")

newModule("are-deps-equal", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.utils.are-deps-equal", "Sinny.include.node_modules.roact-hooked.out.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.utils.are-deps-equal")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.utils.are-deps-equal")) return fn() end)

newModule("memoized-hook", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.utils.memoized-hook", "Sinny.include.node_modules.roact-hooked.out.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.utils.memoized-hook")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.utils.memoized-hook")) return fn() end)

newModule("with-hooks", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.with-hooks", "Sinny.include.node_modules.roact-hooked.out", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
local exports = {}\
local _with_hooks = TS.import(script, script, \"with-hooks\")\
...
return exports\
", '@'.."Sinny.include.node_modules.roact-hooked.out.with-hooks")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.with-hooks")) return fn() end)

newModule("component-with-hooks", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.with-hooks.component-with-hooks", "Sinny.include.node_modules.roact-hooked.out.with-hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
local _memoized_hook = TS.import(script, script.Parent.Parent, \"utils\", \"memoized-hook\")\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.with-hooks.component-with-hooks")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.with-hooks.component-with-hooks")) return fn() end)

newModule("with-hooks", "ModuleScript", "Sinny.include.node_modules.roact-hooked.out.with-hooks.with-hooks", "Sinny.include.node_modules.roact-hooked.out.with-hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
...
", '@'.."Sinny.include.node_modules.roact-hooked.out.with-hooks.with-hooks")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-hooked.out.with-hooks.with-hooks")) return fn() end)

newInstance("roact-rodux-hooked", "Folder", "Sinny.include.node_modules.roact-rodux-hooked", "Sinny.include.node_modules")

newModule("out", "ModuleScript", "Sinny.include.node_modules.roact-rodux-hooked.out", "Sinny.include.node_modules.roact-rodux-hooked", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
local TS = _G[script]\
local exports = {}\
...
return exports\
", '@'.."Sinny.include.node_modules.roact-rodux-hooked.out")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-rodux-hooked.out")) return fn() end)

newInstance("components", "Folder", "Sinny.include.node_modules.roact-rodux-hooked.out.components", "Sinny.include.node_modules.roact-rodux-hooked.out")

newModule("context", "ModuleScript", "Sinny.include.node_modules.roact-rodux-hooked.out.components.context", "Sinny.include.node_modules.roact-rodux-hooked.out.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
local TS = _G[script]\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
...
", '@'.."Sinny.include.node_modules.roact-rodux-hooked.out.components.context")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-rodux-hooked.out.components.context")) return fn() end)

newModule("provider", "ModuleScript", "Sinny.include.node_modules.roact-rodux-hooked.out.components.provider", "Sinny.include.node_modules.roact-rodux-hooked.out.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
local TS = _G[script]\
...
", '@'.."Sinny.include.node_modules.roact-rodux-hooked.out.components.provider")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-rodux-hooked.out.components.provider")) return fn() end)

newInstance("helpers", "Folder", "Sinny.include.node_modules.roact-rodux-hooked.out.helpers", "Sinny.include.node_modules.roact-rodux-hooked.out")

newModule("shallow-equal", "ModuleScript", "Sinny.include.node_modules.roact-rodux-hooked.out.helpers.shallow-equal", "Sinny.include.node_modules.roact-rodux-hooked.out.helpers", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
local TS = _G[script]\
...
", '@'.."Sinny.include.node_modules.roact-rodux-hooked.out.helpers.shallow-equal")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-rodux-hooked.out.helpers.shallow-equal")) return fn() end)

newInstance("hooks", "Folder", "Sinny.include.node_modules.roact-rodux-hooked.out.hooks", "Sinny.include.node_modules.roact-rodux-hooked.out")

newModule("use-dispatch", "ModuleScript", "Sinny.include.node_modules.roact-rodux-hooked.out.hooks.use-dispatch", "Sinny.include.node_modules.roact-rodux-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
local TS = _G[script]\
...
", '@'.."Sinny.include.node_modules.roact-rodux-hooked.out.hooks.use-dispatch")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-rodux-hooked.out.hooks.use-dispatch")) return fn() end)

newModule("use-selector", "ModuleScript", "Sinny.include.node_modules.roact-rodux-hooked.out.hooks.use-selector", "Sinny.include.node_modules.roact-rodux-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
local TS = _G[script]\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local useEffect = _roact_hooked.useEffect\
local useMutable = _roact_hooked.useMutable\
...
", '@'.."Sinny.include.node_modules.roact-rodux-hooked.out.hooks.use-selector")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-rodux-hooked.out.hooks.use-selector")) return fn() end)

newModule("use-store", "ModuleScript", "Sinny.include.node_modules.roact-rodux-hooked.out.hooks.use-store", "Sinny.include.node_modules.roact-rodux-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
local TS = _G[script]\
...
", '@'.."Sinny.include.node_modules.roact-rodux-hooked.out.hooks.use-store")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-rodux-hooked.out.hooks.use-store")) return fn() end)

newModule("types", "ModuleScript", "Sinny.include.node_modules.roact-rodux-hooked.out.types", "Sinny.include.node_modules.roact-rodux-hooked.out", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
--[[\
\9*\
\9* A Roact Context\
]]\
return nil\
", '@'.."Sinny.include.node_modules.roact-rodux-hooked.out.types")) setfenv(fn, newEnv("Sinny.include.node_modules.roact-rodux-hooked.out.types")) return fn() end)

newInstance("rodux", "Folder", "Sinny.include.node_modules.rodux", "Sinny.include.node_modules")

newModule("src", "ModuleScript", "Sinny.include.node_modules.rodux.src", "Sinny.include.node_modules.rodux", function () local fn = assert(loadstring("local Store = require(script.Store)\
...
", '@'.."Sinny.include.node_modules.rodux.src")) setfenv(fn, newEnv("Sinny.include.node_modules.rodux.src")) return fn() end)

newModule("NoYield", "ModuleScript", "Sinny.include.node_modules.rodux.src.NoYield", "Sinny.include.node_modules.rodux.src", function () local fn = assert(loadstring("--!nocheck\
\
--[[\
...
\
return NoYield\
", '@'.."Sinny.include.node_modules.rodux.src.NoYield")) setfenv(fn, newEnv("Sinny.include.node_modules.rodux.src.NoYield")) return fn() end)

newModule("Signal", "ModuleScript", "Sinny.include.node_modules.rodux.src.Signal", "Sinny.include.node_modules.rodux.src", function () local fn = assert(loadstring("--[[\
...
\
return Signal", '@'.."Sinny.include.node_modules.rodux.src.Signal")) setfenv(fn, newEnv("Sinny.include.node_modules.rodux.src.Signal")) return fn() end)

newModule("Store", "ModuleScript", "Sinny.include.node_modules.rodux.src.Store", "Sinny.include.node_modules.rodux.src", function () local fn = assert(loadstring("local RunService = game:GetService(\"RunService\")\
\
...
\
return Store\
", '@'.."Sinny.include.node_modules.rodux.src.Store")) setfenv(fn, newEnv("Sinny.include.node_modules.rodux.src.Store")) return fn() end)

newModule("combineReducers", "ModuleScript", "Sinny.include.node_modules.rodux.src.combineReducers", "Sinny.include.node_modules.rodux.src", function () local fn = assert(loadstring("--[[\
...
", '@'.."Sinny.include.node_modules.rodux.src.combineReducers")) setfenv(fn, newEnv("Sinny.include.node_modules.rodux.src.combineReducers")) return fn() end)

newModule("createReducer", "ModuleScript", "Sinny.include.node_modules.rodux.src.createReducer", "Sinny.include.node_modules.rodux.src", function () local fn = assert(loadstring("return function(initialState, handlers)\
\9return function(state, action)\
\9\9if state == nil then\
...
", '@'.."Sinny.include.node_modules.rodux.src.createReducer")) setfenv(fn, newEnv("Sinny.include.node_modules.rodux.src.createReducer")) return fn() end)

newModule("loggerMiddleware", "ModuleScript", "Sinny.include.node_modules.rodux.src.loggerMiddleware", "Sinny.include.node_modules.rodux.src", function () local fn = assert(loadstring("-- We want to be able to override outputFunction in tests, so the shape of this\
...
", '@'.."Sinny.include.node_modules.rodux.src.loggerMiddleware")) setfenv(fn, newEnv("Sinny.include.node_modules.rodux.src.loggerMiddleware")) return fn() end)

newModule("makeActionCreator", "ModuleScript", "Sinny.include.node_modules.rodux.src.makeActionCreator", "Sinny.include.node_modules.rodux.src", function () local fn = assert(loadstring("--[[\13\
...
", '@'.."Sinny.include.node_modules.rodux.src.makeActionCreator")) setfenv(fn, newEnv("Sinny.include.node_modules.rodux.src.makeActionCreator")) return fn() end)

newModule("prettyPrint", "ModuleScript", "Sinny.include.node_modules.rodux.src.prettyPrint", "Sinny.include.node_modules.rodux.src", function () local fn = assert(loadstring("local indent = \"    \"\
\
...
\
return prettyPrint", '@'.."Sinny.include.node_modules.rodux.src.prettyPrint")) setfenv(fn, newEnv("Sinny.include.node_modules.rodux.src.prettyPrint")) return fn() end)

newModule("thunkMiddleware", "ModuleScript", "Sinny.include.node_modules.rodux.src.thunkMiddleware", "Sinny.include.node_modules.rodux.src", function () local fn = assert(loadstring("--[[\
...
", '@'.."Sinny.include.node_modules.rodux.src.thunkMiddleware")) setfenv(fn, newEnv("Sinny.include.node_modules.rodux.src.thunkMiddleware")) return fn() end)

newModule("services", "ModuleScript", "Sinny.include.node_modules.services", "Sinny.include.node_modules", function () local fn = assert(loadstring("return setmetatable({}, {\
...
", '@'.."Sinny.include.node_modules.services")) setfenv(fn, newEnv("Sinny.include.node_modules.services")) return fn() end)

newInstance("types", "Folder", "Sinny.include.node_modules.types", "Sinny.include.node_modules")

newInstance("include", "Folder", "Sinny.include.node_modules.types.include", "Sinny.include.node_modules.types")

newInstance("generated", "Folder", "Sinny.include.node_modules.types.include.generated", "Sinny.include.node_modules.types.include")
